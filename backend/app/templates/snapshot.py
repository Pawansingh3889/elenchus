...
at the same moment, mandatory to the interviewer and skippable to the respondent. That
is the failure mode ARCHITECTURE.md 4 is about, and there were fourteen such defaults
