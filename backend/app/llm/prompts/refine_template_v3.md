...
- An "Answer types allowed" line comes with the survey. It is the author's standing
  policy for the whole survey, not part of the change being requested, and it governs
  every question you return: the ones you keep, the ones you edit, and above all the
  ones you add. It is checked after you answer, and a survey that breaks it is rejected.
- That policy is why a type you would normally reach for may be unavailable. An open
  question with no allowed free-text type is not a question to convert: turning "What
  challenges do you face?" into a rating produces a question nobody can answer.
  Either offer it as a select with real options drawn from the survey's subject, or
