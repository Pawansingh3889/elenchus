...
def upgrade() -> None:
    ...
    op.execute(
        text("UPDATE survey_templates SET audience = 'managers' WHERE id = '460791a5-ca31-485c-991c-0e64762d2222'")
    )
    
    # factory-floor-compliance: supervisors
    op.execute(
        text("UPDATE survey_templates SET audience = 'supervisors' WHERE id = '00e74feb-69c7-4f85-8419-313bd1b96787'")
    )
    
    # new-hire-onboarding: everyone
    op.execute(
        text("UPDATE survey_templates SET audience = 'everyone' WHERE id = '323b17e2-aa57-416a-b87d-81da879f46ca'")
    )
    
    # team-lead: managers
    op.execute(
        text("UPDATE survey_templates SET audience = 'managers' WHERE id = '2bbabbb6-55b6-4a35-b2b9-2dddda78b46c'")
    )
    
    # safety-equipment-ppe: health_safety
    op.execute(
        text("UPDATE survey_templates SET audience = 'health_safety' WHERE id = 'a1b2c3d4-e5f6-7890-abcd-ef1234567890'")
    )
    
    # shift-handover: shift_managers
    op.execute(
        text("UPDATE survey_templates SET audience = 'shift_managers' WHERE id = 'b8c9d0e1-f2a3-4567-bcde-678901234567'")
    )
    
    # ai-tools-plant: everyone
    op.execute(
        text("UPDATE survey_templates SET audience = 'everyone' WHERE id = 'deda8e62-3176-4327-8a8e-d11f2d187108'")
    )
...
def downgrade() -> None:
    ...
    op.execute(
        text("UPDATE survey_templates SET audience = NULL WHERE id IN ('460791a5-ca31-485c-991c-0e64762d2222', '00e74feb-69c7-4f85-8419-313bd1b96787', '323b17e2-aa57-416a-b87d-81da879f46ca', '2bbabbb6-55b6-4a35-b2b9-2dddda78b46c', 'a1b2c3d4-e5f6-7890-abcd-ef1234567890', 'b8c9d0e1-f2a3-4567-bcde-678901234567', 'deda8e62-3176-4327-8a8e-d11f2d187108')")
    )
