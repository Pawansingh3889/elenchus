...
export const pl: Messages = {
  ...
  landing: {
    ...
    audienceEveryone: "Wszyscy",
    audienceOperatives: "Operatorzy",
    audienceLineLeaders: "Liderzy linii",
    audienceSupervisors: "Kierownicy zmiany",
    audienceManagers: "Menedżerowie",
    audienceQa: "Kontrola jakości",
    audiencePerson: "Jedna osoba",
