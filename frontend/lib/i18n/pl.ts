...
export const pl: Messages = {
  ...
  people: {
    ...
    summaryTotal: "Liczba wszystkich osób",
    summaryAuthors: "Autorzy (szczebel ≥ kierownik)",
    summaryAdmins: "Admini (obszar IT)",
    summaryNoJob: "Brak przypisanego stanowiska",
    summaryByFunction: "Według obszaru",
    summaryByBand: "Według szczebla",
    summaryAudienceReach: "Zasięg odbiorców",
    summaryReachTotal: "Łączny zasięg",
  },
  admin: {
  ...
  builder: {
    ...
    followUpsNever: "Nigdy nie pytać",
    followUpsWhenUnclear: "Pytać, gdy odpowiedź niejasna (domyślnie)",
    followUpsAlwaysOnce: "Zawsze dopytać raz",
  ...
  report: {
    ...
    recapSuggestions: "Co zaproponowali respondenci",
  },
  results: {
    title: "Odpowiedzi",
