...
export const pl: Messages = {
  ...
  people: {
    ...
    colGroups: "Grupy",
    roleAuthor: "Autor",
    roleRespondent: "Odpowiadający",
    noGroups: "W żadnej grupie, więc nie można o nic zapytać",
  ...
  admin: {
    ...
    newSubtitle: "Będzie można ją o coś zapytać, gdy tylko znajdzie się w grupie.",
    editTitle: "Edytuj konto",
    editSubtitle: "To zastępuje konto w obecnej postaci, razem z grupami.",
    emailLabel: "Adres e-mail",
    emailFixed: "Ustawiany raz, przy tworzeniu konta.",
    nameLabel: "Imię i nazwisko",
    roleLabel: "Rodzaj konta",
    roleAuthorHint: "Tworzy ankiety i czyta wyniki. Potrzebuje działu.",
    roleRespondentHint: "Odpowiada na ankiety. Potrzebuje co najmniej jednej grupy.",
    departmentLabel: "Dział",
    departmentNone: "Brak",
    groupsLabel: "Grupy na hali",
    groupsHint: "Czym zajmuje się na linii. Grupy się nakładają, więc zaznacz wszystkie pasujące.",
    ...
    noEntraIdWhy:
      "Ta osoba dziś tworzy ankiety i nie mogłaby się zalogować po włączeniu logowania Microsoft.",
