...
export const es: Messages = {
  ...
  people: {
    ...
    summaryTotal: "Total de personas",
    summaryAuthors: "Autores (nivel ≥ responsable)",
    summaryAdmins: "Admins (área IT)",
    summaryNoJob: "Sin puesto asignado",
    summaryByFunction: "Por área",
    summaryByBand: "Por nivel",
    summaryAudienceReach: "Alcance por audiencia",
    summaryReachTotal: "Alcance total",
  },
  admin: {
  ...
  builder: {
    ...
    followUpsWhenUnclear: "Repreguntar si la respuesta no queda clara (por defecto)",
    followUpsAlwaysOnce: "Repreguntar siempre una vez",
