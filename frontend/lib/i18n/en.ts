...
export const en = {
  ...
  people: {
    ...
    noGroups: "In no group, so cannot be asked anything",
  ...
  admin: {
    ...
    newSubtitle: "They can be asked something as soon as they are in a group.",
    editTitle: "Edit account",
    editSubtitle: "This replaces the account as it stands, groups included.",
    emailLabel: "Email address",
    emailFixed: "Set once, when the account is made.",
    nameLabel: "Name",
    roleLabel: "Account type",
    roleAuthorHint: "Builds surveys and reads results. Needs a department.",
    roleRespondentHint: "Answers surveys. Needs at least one group.",
    departmentLabel: "Department",
    departmentNone: "None",
    groupsLabel: "Groups on the floor",
    groupsHint: "What they do on the line. These overlap, so pick as many as apply.",
    ...
    noEntraIdWhy: "This author builds surveys today and could not sign in once Microsoft sign-in is switched on.",
