...
export const lt: Messages = {
  ...
  landing: {
    ...
    audienceOperatives: "Operatoriai",
    audienceLineLeaders: "Linijos vadovai",
    audienceSupervisors: "Pamainos vadovai",
    audienceManagers: "Vadovai",
    audienceQa: "Kokybės kontrolė",
    audiencePerson: "Vienas žmogus",
