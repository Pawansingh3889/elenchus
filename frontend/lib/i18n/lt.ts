...
export const lt: Messages = {
  ...
  people: {
    ...
    colName: "Vardas",
    colRole: "Paskyra",
    colDepartment: "Skyrius",
    colGroups: "Grupės",
    roleAuthor: "Autorius",
    roleRespondent: "Respondentas",
    noGroups: "Nėra jokioje grupėje, todėl nieko negalima paklausti",
  ...
  admin: {
    ...
    newSubtitle: "Jo bus galima ko nors paklausti, kai tik jis bus grupėje.",
    editTitle: "Redaguoti paskyrą",
    editSubtitle: "Tai pakeičia paskyrą tokią, kokia ji yra, įskaitant grupes.",
    emailLabel: "El. pašto adresas",
    emailFixed: "Nustatomas vieną kartą, kuriant paskyrą.",
    nameLabel: "Vardas",
    roleLabel: "Paskyros tipas",
    roleAuthorHint: "Kuria apklausas ir skaito rezultatus. Reikia skyriaus.",
    roleRespondentHint: "Atsako į apklausas. Reikia bent vienos grupės.",
    departmentLabel: "Skyrius",
    departmentNone: "Nėra",
    groupsLabel: "Grupės gamykloje",
    groupsHint: "Ką jis veikia linijoje. Jos persidengia, todėl pažymėk visas tinkamas.",
    ...
    noEntraIdWhy:
      "Šis autorius šiandien kuria apklausas ir negalėtų prisijungti, kai bus įjungtas Microsoft prisijungimas.",
