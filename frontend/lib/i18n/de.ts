...
export const de: Messages = {
  ...
  people: {
    ...
    summaryTotal: "Gesamtzahl Personen",
    summaryAuthors: "Autoren (Band ≥ Manager)",
    summaryAdmins: "Admins (IT-Bereich)",
    summaryNoJob: "Keine Tätigkeit zugewiesen",
    summaryByFunction: "Nach Bereich",
    summaryByBand: "Nach Ebene",
    summaryAudienceReach: "Zielgruppen-Reichweite",
    summaryReachTotal: "Gesamt-Reichweite",
  },
  admin: {
  ...
  builder: {
    ...
    followUpsNever: "Nie nachfragen",
    followUpsWhenUnclear: "Nachfragen bei unklarer Antwort (Standard)",
  ...
  report: {
    ...
    recapSuggestions: "Was die Befragten vorgeschlagen haben",
  },
  results: {
    title: "Antworten",
