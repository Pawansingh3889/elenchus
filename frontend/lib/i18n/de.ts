...
export const de: Messages = {
  ...
  people: {
    ...
    colGroups: "Gruppen",
    roleAuthor: "Autor",
    roleRespondent: "Befragte Person",
    noGroups: "In keiner Gruppe, kann also nichts gefragt werden",
  ...
  admin: {
    ...
    newSubtitle: "Sobald sie in einer Gruppe ist, kann sie befragt werden.",
    editTitle: "Konto bearbeiten",
    editSubtitle: "Das ersetzt das Konto so, wie es ist, samt seiner Gruppen.",
    emailLabel: "E-Mail-Adresse",
    emailFixed: "Wird einmalig beim Anlegen des Kontos gesetzt.",
    nameLabel: "Name",
    roleLabel: "Kontoart",
    roleAuthorHint: "Erstellt Umfragen und liest Ergebnisse. Braucht eine Abteilung.",
    roleRespondentHint: "Beantwortet Umfragen. Braucht mindestens eine Gruppe.",
    departmentLabel: "Abteilung",
    departmentNone: "Keine",
    groupsLabel: "Gruppen im Betrieb",
    groupsHint: "Was sie an der Linie tun. Das überschneidet sich, also alles Zutreffende wählen.",
    ...
    noEntraIdWhy:
      "Diese Person erstellt heute Umfragen und könnte sich nicht mehr anmelden, sobald die Microsoft-Anmeldung aktiv ist.",
