...
export const fil: Messages = {
  ...
  landing: {
    ...
    audienceEveryone: "Lahat",
    audienceOperatives: "Mga operatiba",
    audienceLineLeaders: "Mga line leader",
    audienceSupervisors: "Mga superbisor",
    audienceManagers: "Mga manedyer",
    audienceQa: "QA",
    audiencePerson: "Isang tao",
