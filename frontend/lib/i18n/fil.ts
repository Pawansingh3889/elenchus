...
export const fil: Messages = {
  ...
  people: {
    ...
    colGroups: "Mga grupo",
    roleAuthor: "May-akda",
    roleRespondent: "Sumasagot",
    noGroups: "Walang grupo, kaya walang maitatanong sa kanya",
  ...
  admin: {
    ...
    newSubtitle: "Matatanong na siya kapag nasa isang grupo na siya.",
    editTitle: "I-edit ang account",
    editSubtitle: "Papalitan nito ang account gaya ng kasalukuyan, pati ang mga grupo nito.",
    emailLabel: "Email address",
    emailFixed: "Isang beses lang itinatakda, kapag ginawa ang account.",
    nameLabel: "Pangalan",
    roleLabel: "Uri ng account",
    roleAuthorHint: "Gumagawa ng survey at nagbabasa ng resulta. Kailangan ng departamento.",
    roleRespondentHint: "Sumasagot ng survey. Kailangan ng kahit isang grupo.",
    departmentLabel: "Departamento",
    departmentNone: "Wala",
    groupsLabel: "Mga grupo sa planta",
    groupsHint: "Ang ginagawa nila sa linya. Nagsasapawan ito, kaya piliin lahat ng akma.",
    ...
    noEntraIdWhy:
      "Gumagawa ng survey ang may-akdang ito ngayon at hindi makakapag-sign in kapag binuksan na ang Microsoft sign-in.",
    ...
    historyRole: (r: string) => `ngayon ay ${r}`,
