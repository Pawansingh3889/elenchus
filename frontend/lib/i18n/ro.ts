...
export const ro: Messages = {
  ...
  people: {
    ...
    noGroups: "În niciun grup, deci nu i se poate cere nimic",
  ...
  admin: {
    ...
    newSubtitle: "Va putea fi întrebată ceva de îndată ce face parte dintr-un grup.",
    editTitle: "Editează contul",
    editSubtitle: "Aceasta înlocuiește contul așa cum este, inclusiv grupurile lui.",
    emailLabel: "Adresă de e-mail",
    emailFixed: "Se stabilește o singură dată, la crearea contului.",
    nameLabel: "Nume",
    roleLabel: "Tipul contului",
    roleAuthorHint: "Creează sondaje și citește rezultatele. Are nevoie de un departament.",
    roleRespondentHint: "Răspunde la sondaje. Are nevoie de cel puțin un grup.",
    departmentLabel: "Departament",
    departmentNone: "Niciunul",
    groupsLabel: "Grupuri în fabrică",
    groupsHint: "Ce face pe linie. Se suprapun, așa că alege toate cele potrivite.",
    ...
    noEntraIdWhy:
      "Acest autor creează sondaje astăzi și nu s-ar putea autentifica după activarea autentificării Microsoft.",
