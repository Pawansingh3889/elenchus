...
export const lv: Messages = {
  ...
  landing: {
    ...
    audienceEveryone: "Visi",
    audienceOperatives: "Operatori",
    audienceLineLeaders: "Līnijas vadītāji",
    audienceSupervisors: "Maiņas vadītāji",
    audienceManagers: "Vadītāji",
    audienceQa: "Kvalitātes kontrole",
    audiencePerson: "Viena persona",
