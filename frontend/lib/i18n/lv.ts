...
export const lv: Messages = {
  ...
  people: {
    ...
    colName: "Vārds",
    colRole: "Konts",
    colDepartment: "Nodaļa",
    colGroups: "Grupas",
    roleAuthor: "Autors",
    roleRespondent: "Respondents",
    noGroups: "Nav nevienā grupā, tāpēc neko nevar pajautāt",
  ...
  admin: {
    ...
    newSubtitle: "Viņam varēs kaut ko jautāt, tiklīdz viņš būs kādā grupā.",
    editTitle: "Rediģēt kontu",
    editSubtitle: "Tas aizstāj kontu tādu, kāds tas ir, ieskaitot grupas.",
    emailLabel: "E-pasta adrese",
    emailFixed: "Tiek iestatīta vienreiz, veidojot kontu.",
    nameLabel: "Vārds",
    roleLabel: "Konta veids",
    roleAuthorHint: "Veido aptaujas un lasa rezultātus. Nepieciešama nodaļa.",
    roleRespondentHint: "Atbild uz aptaujām. Nepieciešama vismaz viena grupa.",
    departmentLabel: "Nodaļa",
    departmentNone: "Nav",
    groupsLabel: "Grupas ražotnē",
    groupsHint: "Ko viņš dara uz līnijas. Tās pārklājas, tāpēc atzīmē visas atbilstošās.",
    ...
    noEntraIdWhy:
      "Šis autors šodien veido aptaujas un nevarētu pieteikties, kad būs ieslēgta Microsoft pieteikšanās.",
