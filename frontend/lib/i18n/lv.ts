...
export const lv: Messages = {
  ...
  people: {
    ...
    summaryTotal: "Cilvēku kopskaits",
    summaryAuthors: "Autori (līmenis ≥ vadītājs)",
    summaryAdmins: "Admini (IT joma)",
    summaryNoJob: "Nav piešķirts amats",
    summaryByFunction: "Pēc jomas",
    summaryByBand: "Pēc līmeņa",
    summaryAudienceReach: "Auditorijas sasniegums",
    summaryReachTotal: "Kopējais sasniegums",
  },
  admin: {
  ...
  builder: {
    ...
    followUpsNever: "Nekad nejautāt",
    followUpsWhenUnclear: "Jautāt, ja atbilde nav skaidra (noklusējums)",
  ...
  report: {
    ...
    recapSuggestions: "Ko respondenti ierosināja",
  },
  results: {
    title: "Atbildes",
